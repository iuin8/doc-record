...
export default async function createConfig() {
  ...
  const localized = configLocalized as Record<string, Record<string, string>>;

  const config: Config = {
    title: localized.title[locale] || localized.title[defaultLocale],
    tagline: localized.tagline[locale] || localized.tagline[defaultLocale],
