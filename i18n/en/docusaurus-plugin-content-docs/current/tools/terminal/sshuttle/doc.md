...
sshuttle --sudoers-user fa-r mac.intranet.company 10.0. /24 --dns — method auto
...
# -D run
sshuttle --sudoers-user fa-r mac.intranet.company 10.0/24 --dns --method auto-nots -D
```
...
sshuttle --dns --auto-hosts --auto-nets -D -r mac. ntranet.company 10.0.0.0.24 100.20.0.0.0.0.0.0/ 16 100.19.0.0/
```
