...
redefine /com/mall/domain/enums/ShowFrequencyTypeEnum. Lass xx. Lass
# or use reshaping class (PS: this order can see load with jad)
reform/com/mall/domain/enums/ShowFrequencyTypeEnum.lass xx. Lass
