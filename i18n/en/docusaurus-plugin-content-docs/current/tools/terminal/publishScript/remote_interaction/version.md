# Version Log - Remote Interaction (idea uses gradle to interface with remote servers - Publish service to connect arthas)
...
>   - Maximal rows that the log behaviour idea console can contain, followed by real time scrolling for new logs
