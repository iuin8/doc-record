...
### Option A: Application of Official DocSearch Creepy (recommended)
...
- Make sure the needs are running successfully and index your website
...
npm install --save @docus/theme-search-algolia --legacy-de-deps
