# How to synchronize network time with timedatabase orders
...
3. [system - How to sync the time to network with till on Ubuntu 18.04? - Ask Ubuntu] (https://askubuntu.com/questions/1058593/how-to-sync-the-network-with-timedatel-on-ubuntu-18-04)
