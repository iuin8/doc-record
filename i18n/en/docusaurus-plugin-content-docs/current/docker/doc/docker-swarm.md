...
# Specify subnet range (PS: prevention and host IP conflicts (error: No route to host))
docker warm init --default-addr-pool 192. 68.0.0/16
```
...
# 2376 for docker machine on the entity machine, is not always needed.
