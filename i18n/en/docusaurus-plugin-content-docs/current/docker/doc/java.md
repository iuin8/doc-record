...
[参考链接](https://www.cnblogs.com/haimishasha/p/9909055.html)
    ...
    # Amazon release
    https://docs.aws.amazon.com/corretto/latest/coretto-8-ug/downloads-list.html
    wget https://corretto. ws/downloads/latest/amazon-retto-8-x64-linux-jdk.tar.gz
    wget https://corretto/downloads/latest/amazon-corretto-11-x-linux-jdk.tar.gz
    
    tar -zxvf openjdk-8u41-b04-linux-x64-14_jan_20.tar.gz # After download
    ````
    `````
