...
firewall-cmd --permanent --zone=trusted --change-interface=docker=docker=docker=docker0
...
> If you have any validity, you will use the Agent Restart method. It sometime loops to be a half-day break, and it is good to reboot the last!
