...
sudo curl -L https://github.com/docker/compose/releases/download/v2.11.2/dock-link-x86_64 > /usr/local/bin/docker-compose
...
> Please note that using package management will ensure that it is an official and stable strength. This latest version may be installed using the pip, but in some cases depending or compatibility problems may be counted.
