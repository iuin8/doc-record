# Use a docker from a remote server to use a debug remote containing

> Benefits: Use a remote docker containing to reduce pressure on the local environment and reduce some of the worst tools (e). LibreOffice that you need to install Java programs in your local environment
