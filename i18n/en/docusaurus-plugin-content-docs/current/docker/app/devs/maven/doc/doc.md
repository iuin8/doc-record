...
## Delete maven repository invalid jar package scripts
...
and double clickon, Enter the address of the Mavenn repository or drag the repository folder into the command.
