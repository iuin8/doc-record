...
- p 139:139 #Map the host's 139 port to samba_docker's container with
-p 445: 445 #
-v /home/shareA# of the host's shared directory to map the container
...
```shell
docker run -it --name samba_docker -p 139:139 -p 445-v /home/shares/shares:/home/shares --w -w -w -w -d dperson/samba -w "WORKGROUP" -u "user;pwd" -s "share;/home/shares/share;yes;no;no;user"
