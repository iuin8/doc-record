...
$ sudo su
# First Update system
$ apt update && apt full-upgrad -y
# Install cert
$ apt install certbot
# Start sign with email domain name signed to your own
$ certbot -standone-n --agree-tos --email webmaster@abc. om --preference-challenges HTML -d dns.abc.com
```
...
- Use DNS Cloak setting on demand auto-witness on iOS
...
2400:3200:1
2400:3200:baba:1
https://dns.aliids.com/dns-query
tlsP/dns.idns.com
```
