...
sudo dnf install cash core uses curl edk2-tools genisoimage grep jq mesa-demos pciuulls processes python3 qemu sed socat spic-gtk-tools swtpm unzip usbutil-linux xdg-uss-dirs xrandr zsync
