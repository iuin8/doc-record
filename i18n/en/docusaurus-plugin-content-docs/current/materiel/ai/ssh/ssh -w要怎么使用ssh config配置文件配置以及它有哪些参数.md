...
| `PermitLocalCommand` | Ways to execute orders locally (e.g. auto-configuration IP address).          |
...
Host my-tunnel-host
  ...
  LocalCommand sudo ipaddr. .0.1/24 dev tun0 && sudo ip link set tun0 up
```

---

### General questions and invitations\*_\\_
