...
Manual submodules on Git is a way to use one Git repository as a subdirectory for another Git repository. His approach is useless when your main project needs to be re-on another project, which in turn has its own version control needs.
...
Alternative, you can use a command to initiate and update all subjects：
...
- Sub items can be nested, i.e. Subprojects can contain other subitems.
