...
# Updates local available information from the art repository
helm repo update  
helm install metersphe/metersphere -n ms

# Create Node Port Access
## Use command kubectl get svc -n ms to view the port number used by meterphere-gateway. If access is not used, To create a nodeport.
