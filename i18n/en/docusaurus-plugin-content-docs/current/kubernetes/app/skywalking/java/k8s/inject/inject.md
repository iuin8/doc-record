...
In skywalking-swck, Customs Metrics Adchapter is an optional component to extend SkyWalking. Follow you to collect and display monitoring indicators using the Customers Metrics API in Kubernetes.
