...
Make sure that all of the submodules it takes on are closed and set up so that developers can start working directly without directly initiating and updating submodules.
