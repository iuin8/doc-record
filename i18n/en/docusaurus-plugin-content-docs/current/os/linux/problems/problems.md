...
By default, the value of vm.max_map_count may be low (e.g. 65530), which may not be sufficient for some applications. n Application may OutOfMemoryError or similar errors when trying to create more memory applies.
